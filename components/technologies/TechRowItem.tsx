...
export function TechRowItem({ tech, isExpanded, isHighlighted, onToggle, defaultSection, highlightItemId }: {
  ...
  return (
    <>
      <div id={`tech-${tech.id}`} className={cn('group border-b border-border transition-colors duration-700', isExpanded && 'bg-accent dark:bg-[#18191a]', isHighlighted && 'bg-primary/20')}>
